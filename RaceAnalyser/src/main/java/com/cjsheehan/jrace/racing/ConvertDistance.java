    ...
    public static double toYards(String distance) {
        ...
        if(mMFY.matches()) {
            yards = (YDS_PER_MILE * Integer.parseInt(mMFY.group(1)))
                        + (YDS_PER_FURLONG * Integer.parseInt(mMFY.group(2)))
                        + Integer.parseInt(mMFY.group(3));
            ...
            yards = (YDS_PER_MILE * Integer.parseInt(mMY.group(1)))
                    + Integer.parseInt(mMY.group(2));
            
        } else if(mM.matches()) {
            yards = (YDS_PER_MILE * Integer.parseInt(mM.group(1)));
            
        } else if(mFY.matches()) {
            yards = (YDS_PER_FURLONG * Integer.parseInt(mFY.group(1)))
                    + Integer.parseInt(mFY.group(2));
