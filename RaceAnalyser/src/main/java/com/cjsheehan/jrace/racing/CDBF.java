...
public class CDBF {
    ...
    /**
     * @param wonAtCourse the wonAtCourse to set
     */
    ...
    /**
     * @param wonAtDistance the wonAtDistance to set
     */
    ...
    /**
     * @param wonAtCourseAndDistance the wonAtCourseAndDistance to set
     */
    ...
    /**
     * @param beatenFavourite the beatenFavourite to set
     */
	...
	return new ToStringBuilder(this)
		.append("Distance winner", hasWonAtDistance())
		.append("Course winner", hasWonAtCourse())
		.append("Course&Distance winner", hasWonAtCourseAndDistance())
		.append("Beaten favourite", isBeatenFavourite())
		.toString();
    }
